# VFI function. Used soley to solve the adjuster problem
...
def solve_adj(t,sol,par):
    ...
    for i_p in prange(par.Np):
        ...
        for i_x in range(par.Nx):
            ...
            objective = obj_adj(par.allow, x, par) # utility values on grid of allowed housing
            d[i_p,i_x] = np.argmax(objective) # Find optimal value of housing
